...
foreach($query->result() as $row){
  ...
  $article_preview = word_limiter($row->aboutus_content, 15);
  $picture = $row->picture;
...
?>
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                  <h5><a href="<?= $aboutus_url ?>"><?= $row->aboutus_title ?></a></h5>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="<?= $aboutus_url ?>"><button type="button" class="btn btn-sm btn-outline-secondary">View</button></a>
                    </div>
                  </div>
                </div>
              </div>
