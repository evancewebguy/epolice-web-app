	...
	<div class="table-responsive">
	  <table class="table table-striped table-sm">
	    <tbody>
	      <tbody>
	      	<tr>
				<td style="font-weight: bold;">Missing Person Picture</td><td><img style="height: 200px; width: 200px;" src="<?= base_url() ?>homepage_pics/<?= $picture ?>"></td>
			</tr>
			<tr>
		...
		<?php 
		$manage_page_url = base_url()."homepage/manage";
