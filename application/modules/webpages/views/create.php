						...
						<form class="form-horizontal" method="post" action="<?= $form_location ?>">
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea rows="3" class="span7" name="page_keywords"><?php  
									echo $page_keywords;
								?></textarea>
							  </div>
							</div>
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea rows="3" class="span7" name="page_description"><?php  
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span7" name="page_headline" value="<?= $page_headline ?>">
							  </div>
							</div>     
							<div class="control-group hidden-phone">
